  ...
  <div class="row justify-content-center">
              ...
              <tbody>
                <tr class="text-center">
                  ...
                  <td style="cursor: pointer" class="table-success">
                    <a id="WH31" data-editable-weight-wh3><?php echo $WeightKeysData['WH31']['weight'] ?></a>
                  </td>
                </tr>
                <tr class="text-center">
                  <td>WH32</td>
                  <td style="cursor: pointer" class="table-success">
                    <a id="WH32" data-editable-weight-wh3><?php echo $WeightKeysData['WH32']['weight'] ?></a>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <div class="col-9 order-2">
      <div class="card border-warning mb-3">
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table id="wh-WH3-score-table" class='table table-hover' style="margin: 0 auto;">
              <thead class='thead-dark'>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <?php
                  if (isset($FINAL_SCORE_WH['WH3']))
                    foreach ($FINAL_SCORE_WH['WH3'] as  $year => $score) { ?>
...
<script type="text/javascript">
  $('body').on('click', '[data-editable-weight-wh3]', function(e) {
    e.preventDefault();
    var $el = $(this);
    var $input = $('<input type="number" id="' + $el.attr("id") + '" type="text" style="min-width:100px;" class="form-control">').val($el.text());
    $el.replaceWith($input);
    var save = function() {
      var $a = $('<a id="' + $el.attr("id") + '" data-editable-weight-wh3 />').text($input.val());
      $input.replaceWith($a);
    };
